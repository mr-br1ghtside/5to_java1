...
public class FrmManteProd extends JFrame {
	...
	public FrmManteProd() {
		...
		cboProveedores.setBounds(294, 102, 119, 22);
		contentPane.add(cboProveedores);
		
		JLabel lblProveedor = new JLabel("Proveedores");
		lblProveedor.setBounds(223, 106, 61, 14);
	...
	void listado() {
		 ...
		 for (Producto p: lstProductos) {
			 ...
			 imprimir("Cateogria.....: " + p.getObjCategoria().getDescripcion());
	...
	void registrar() {
		 ...
		 try {
			 ...
			 JOptionPane.showMessageDialog(this, "Registro incorrecto" + e.getCause().getMessage());
		 }
